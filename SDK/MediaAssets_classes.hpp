...
public:
	...
	uint8                                         PrecacheFile : 1;                                  // 0x0048(0x0001)(BitIndex: 0xFF, PropSize: 0x0001 (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
public:
	...
	uint8                                         NativeAudioOut : 1;                                // 0x00C0(0x0001)(BitIndex: 0xFF, PropSize: 0x0001 (BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         PlayOnOpen : 1;                                    // 0x00C1(0x0001)(BitIndex: 0xFF, PropSize: 0x0001 (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_C2[0x2];                                       // 0x00C2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         Shuffle : 1;                                       // 0x00C4(0x0001)(BitIndex: 0xFF, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Loop : 1;                                          // 0x00C4(0x0001)(BitIndex: 0xFF, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
...
public:
	uint8 CanPlaySource(class UMediaSource* MediaSource);
	uint8 CanPlayUrl(const class FString& URL);
	void Close();
	uint8 Next();
	uint8 OpenFile(const class FString& FilePath);
	...
	uint8 Reopen();
	uint8 Rewind();
	uint8 Seek(const struct FTimespan& Time);
	uint8 SelectTrack(EMediaPlayerTrack TrackType, int32 TrackIndex);
	void SetDesiredPlayerName(class FName PlayerName);
	uint8 SetLooping(uint8 Looping);
	uint8 SetRate(float Rate);
	uint8 SetTrackFormat(EMediaPlayerTrack TrackType, int32 TrackIndex, int32 FormatIndex);
	uint8 SetVideoTrackFrameRate(int32 TrackIndex, int32 FormatIndex, float FrameRate);
	uint8 SetViewField(float Horizontal, float Vertical, uint8 Absolute);
	uint8 SetViewRotation(const struct FRotator& Rotation, uint8 Absolute);

	uint8 CanPause() const;
	...
	void GetSupportedRates(TArray<struct FFloatRange>* OutRates, uint8 Unthinned) const;
	...
	uint8 IsBuffering() const;
	uint8 IsConnecting() const;
	uint8 IsLooping() const;
	uint8 IsPaused() const;
	uint8 IsPlaying() const;
	uint8 IsPreparing() const;
	uint8 IsReady() const;
	uint8 SupportsRate(float Rate, uint8 Unthinned) const;
	uint8 SupportsScrubbing() const;
	uint8 SupportsSeeking() const;
...
{
public:
	uint8                                         Loop : 1;                                          // 0x0028(0x0001)(BitIndex: 0xFF, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
public:
	uint8 Add(class UMediaSource* MediaSource);
	uint8 AddFile(const class FString& FilePath);
	uint8 AddUrl(const class FString& URL);
	...
	int32 Num();
	uint8 Remove(class UMediaSource* MediaSource);
	uint8 RemoveAt(int32 Index_0);
	uint8 Replace(int32 Index_0, class UMediaSource* Replacement);
