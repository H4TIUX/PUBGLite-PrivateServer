...
void ALandscapeProxy::ChangeLODDistanceFactor(float InLODDistanceFactor)
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("LandscapeProxy", "ChangeLODDistanceFactor");
...
// uint8                                   bRaiseHeights                                          (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// uint8                                   bLowerHeights                                          (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void ALandscapeProxy::EditorApplySpline(class USplineComponent* InSplineComponent, float StartWidth, float EndWidth, float StartSideFalloff, float EndSideFalloff, float StartRoll, float EndRoll, int32 NumSubdivisions, uint8 bRaiseHeights, uint8 bLowerHeights, class ULandscapeLayerInfoObject* PaintLayer)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = GetClass()->GetFunction("LandscapeProxy", "EditorApplySpline");
