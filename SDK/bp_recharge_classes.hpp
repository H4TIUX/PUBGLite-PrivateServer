...
class Abp_recharge_C final : public ALuaClassObj
{
public:
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("bp_recharge_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"bp_recharge_C")
	}
	static class Abp_recharge_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<Abp_recharge_C>();
	}
};
