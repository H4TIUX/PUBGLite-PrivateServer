...
void UGameplayTask::EndTask()
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("GameplayTask", "EndTask");
...
void UGameplayTask::ReadyForActivation()
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("GameplayTask", "ReadyForActivation");
...
// const struct FVector&                   SpawnLocation                                          (Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const struct FRotator&                  SpawnRotation                                          (Parm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
// uint8                                   bSpawnOnlyOnAuthority                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UGameplayTask_SpawnActor* UGameplayTask_SpawnActor::SpawnActor(TScriptInterface<class IGameplayTaskOwnerInterface> TaskOwner, const struct FVector& SpawnLocation, const struct FRotator& SpawnRotation, TSubclassOf<class AActor> Class_0, uint8 bSpawnOnlyOnAuthority)
{
	static class UFunction* Func = nullptr;
...
uint8 UGameplayTask_SpawnActor::BeginSpawningActor(class UObject* WorldContextObject, class AActor** SpawnedActor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = GetClass()->GetFunction("GameplayTask_SpawnActor", "BeginSpawningActor");
...
void UGameplayTask_SpawnActor::FinishSpawningActor(class UObject* WorldContextObject, class AActor* SpawnedActor)
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("GameplayTask_SpawnActor", "FinishSpawningActor");
...
void UGameplayTasksComponent::OnRep_SimulatedTasks()
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("GameplayTasksComponent", "OnRep_SimulatedTasks");
