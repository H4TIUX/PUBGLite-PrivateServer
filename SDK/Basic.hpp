...
namespace Offsets
{
	constexpr int32 GObjects          = 0x046CB6F8;
	constexpr int32 AppendString      = 0x0175D6B0;
	constexpr int32 GNames            = 0x00000000;
	constexpr int32 GWorld            = 0x00000000;
	constexpr int32 ProcessEvent      = 0x004011C0;
...
{
public:
	static constexpr auto DecryptPtr = [](void* ObjPtr) -> uint8_t* { return reinterpret_cast<uint8_t*>(Dec::objobjects(reinterpret_cast<uint64>(ObjPtr))); };
...
public:
	...
	{
		uintptr_t addr = InSDKUtils::GetImageBase() + Offsets::GObjects;
