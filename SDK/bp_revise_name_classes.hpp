...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("bp_revise_name_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"bp_revise_name_C")
	}
	static class Abp_revise_name_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<Abp_revise_name_C>();
	}
};
