...
class UCineCameraComponent* ACineCameraActor::GetCineCameraComponent() const
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("CineCameraActor", "GetCineCameraComponent");
...
void UCineCameraComponent::SetFilmbackPresetByName(const class FString& InPresetName)
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("CineCameraComponent", "SetFilmbackPresetByName");
...
void UCineCameraComponent::SetLensPresetByName(const class FString& InPresetName)
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("CineCameraComponent", "SetLensPresetByName");
...
class FString UCineCameraComponent::GetFilmbackPresetName() const
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("CineCameraComponent", "GetFilmbackPresetName");
...
float UCineCameraComponent::GetHorizontalFieldOfView() const
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("CineCameraComponent", "GetHorizontalFieldOfView");
...
class FString UCineCameraComponent::GetLensPresetName() const
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("CineCameraComponent", "GetLensPresetName");
...
float UCineCameraComponent::GetVerticalFieldOfView() const
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("CineCameraComponent", "GetVerticalFieldOfView");
