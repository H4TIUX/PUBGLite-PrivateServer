...
float UMobileInstalledContent::GetDiskFreeSpace()
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("MobileInstalledContent", "GetDiskFreeSpace");
...
float UMobileInstalledContent::GetInstalledContentSize()
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("MobileInstalledContent", "GetInstalledContentSize");
...
uint8 UMobileInstalledContent::Mount(int32 PakOrder, const class FString& MountPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = GetClass()->GetFunction("MobileInstalledContent", "Mount");
...
float UMobilePendingContent::GetDownloadSize()
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("MobilePendingContent", "GetDownloadSize");
...
float UMobilePendingContent::GetDownloadSpeed()
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("MobilePendingContent", "GetDownloadSpeed");
...
class FText UMobilePendingContent::GetDownloadStatusText()
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("MobilePendingContent", "GetDownloadStatusText");
...
float UMobilePendingContent::GetInstallProgress()
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("MobilePendingContent", "GetInstallProgress");
...
float UMobilePendingContent::GetRequiredDiskSpace()
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("MobilePendingContent", "GetRequiredDiskSpace");
...
float UMobilePendingContent::GetTotalDownloadedSize()
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("MobilePendingContent", "GetTotalDownloadedSize");
...
void UMobilePendingContent::StartInstall(TDelegate<void()> OnSucceeded, TDelegate<void(class FText ErrorText, int32 ErrorCode)> OnFailed)
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("MobilePendingContent", "StartInstall");
...
uint8 UMobilePatchingLibrary::HasActiveWiFiConnection()
{
	static class UFunction* Func = nullptr;
