...
// const struct FVector&                   HitLocation                                            (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const struct FVector&                   ImpulseDir                                             (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UDestructibleComponent::ApplyDamage(float DamageAmount, const struct FVector& HitLocation, const struct FVector& ImpulseDir, float ImpulseStrength)
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("DestructibleComponent", "ApplyDamage");
...
// const struct FVector&                   HurtOrigin                                             (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   DamageRadius                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   ImpulseStrength                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// uint8                                   bFullDamage                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UDestructibleComponent::ApplyRadiusDamage(float BaseDamage, const struct FVector& HurtOrigin, float DamageRadius, float ImpulseStrength, uint8 bFullDamage)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = GetClass()->GetFunction("DestructibleComponent", "ApplyRadiusDamage");
...
class UDestructibleMesh* UDestructibleComponent::GetDestructibleMesh()
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("DestructibleComponent", "GetDestructibleMesh");
...
void UDestructibleComponent::SetDestructibleMesh(class UDestructibleMesh* NewMesh)
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("DestructibleComponent", "SetDestructibleMesh");
