...
public:
	...
	uint8                                         bIsActive : 1;                                     // 0x0100(0x0001)(BitIndex: 0xFF, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bIsLocked : 1;                                     // 0x0100(0x0001)(BitIndex: 0xFF, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bIsInfinite : 1;                                   // 0x0100(0x0001)(BitIndex: 0xFF, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
public:
	...
	uint8                                         bForceFixedFrameIntervalPlayback : 1;              // 0x0118(0x0001)(BitIndex: 0xFF, PropSize: 0x0001 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
{
public:
	uint8                                         bHighPassFilter : 1;                               // 0x00B8(0x0001)(BitIndex: 0xFF, PropSize: 0x0001 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("MovieSceneSegmentCompilerTestTrack")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"MovieSceneSegmentCompilerTestTrack")
	}
...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("MovieSceneSegmentCompilerTestSection")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"MovieSceneSegmentCompilerTestSection")
	}
...
public:
	...
	uint8                                         bParentContextsAreSignificant : 1;                 // 0x0328(0x0001)(BitIndex: 0xFF, PropSize: 0x0001 (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
...
public:
	...
	uint8                                         bReversePlayback : 1;                              // 0x03C4(0x0001)(BitIndex: 0xFF, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bPendingFirstUpdate : 1;                           // 0x03C4(0x0001)(BitIndex: 0xFF, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	...
	int32                                         CurrentNumLoops;                                   // 0x03E4(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_420[0x3D0];                                    // 0x0420(0x03D0)(Fixing Struct Size After Last Property [ Dumper-7 ])
