...
void UMediaPlaneComponent::OnRenderTextureChanged()
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("MediaPlaneComponent", "OnRenderTextureChanged");
...
// Parameters:
// const struct FMediaPlaneParameters&     Plane_0                                                (Parm, NoDestructor, NativeAccessSpecifierPublic)
...
void UMediaPlaneComponent::SetMediaPlane(const struct FMediaPlaneParameters& Plane_0)
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("MediaPlaneComponent", "SetMediaPlane");
...
struct FMediaPlaneParameters UMediaPlaneComponent::GetPlane() const
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("MediaPlaneComponent", "GetPlane");
