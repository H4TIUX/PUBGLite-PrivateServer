...
// const struct FSourceEffectChainEntry&   Entry                                                  (Parm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
// class USoundEffectSourcePresetChain*    PresetChain                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// int32                                   EntryIndex                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// uint8                                   bBypassed                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UAudioMixerBlueprintLibrary::SetBypassSourceEffectChainEntry(const class UObject* WorldContextObject, class USoundEffectSourcePresetChain* PresetChain, int32 EntryIndex, uint8 bBypassed)
{
	static class UFunction* Func = nullptr;
...
void USynthComponent::SetSubmixSend(class USoundSubmix* Submix, float SendLevel)
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("SynthComponent", "SetSubmixSend");
...
void USynthComponent::Start()
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("SynthComponent", "Start");
...
void USynthComponent::Stop()
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("SynthComponent", "Stop");
...
uint8 USynthComponent::IsPlaying() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = GetClass()->GetFunction("SynthComponent", "IsPlaying");
...
// Parameters:
// const struct FSubmixEffectDynamicsProcessorSettings&InSettings                                             (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
void USubmixEffectDynamicsProcessorPreset::SetSettings(const struct FSubmixEffectDynamicsProcessorSettings& InSettings)
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("SubmixEffectDynamicsProcessorPreset", "SetSettings");
...
void USubmixEffectSubmixEQPreset::SetSettings(const struct FSubmixEffectSubmixEQSettings& InSettings)
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("SubmixEffectSubmixEQPreset", "SetSettings");
...
void USubmixEffectReverbPreset::SetSettings(const struct FSubmixEffectReverbSettings& InSettings)
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("SubmixEffectReverbPreset", "SetSettings");
...
void USubmixEffectReverbPreset::SetSettingsWithReverbEffect(const class UReverbEffect* InReverbEffect, const float WetLevel)
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("SubmixEffectReverbPreset", "SetSettingsWithReverbEffect");
