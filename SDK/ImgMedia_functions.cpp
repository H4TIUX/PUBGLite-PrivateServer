...
void UImgMediaSource::SetSequencePath(const class FString& Path)
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("ImgMediaSource", "SetSequencePath");
...
void UImgMediaSource::GetProxies(TArray<class FString>* OutProxies) const
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("ImgMediaSource", "GetProxies");
...
const class FString UImgMediaSource::GetSequencePath() const
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("ImgMediaSource", "GetSequencePath");
