...
{
public:
	uint8                                         bNewLooping : 1;                                   // 0x0000(0x0001)(BitIndex: 0xFF, PropSize: 0x0001 (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
};
