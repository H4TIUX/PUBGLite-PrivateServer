...
public:
	...
	static uint8 DoesContainerMatchTagQuery(const struct FGameplayTagContainer& TagContainer, const struct FGameplayTagQuery& TagQuery);
	static uint8 DoesTagAssetInterfaceHaveTag(TScriptInterface<class IGameplayTagAssetInterface> TagContainerInterface, const struct FGameplayTag& Tag);
	static uint8 EqualEqual_GameplayTag(const struct FGameplayTag& A, const struct FGameplayTag& B);
	static uint8 EqualEqual_GameplayTagContainer(const struct FGameplayTagContainer& A, const struct FGameplayTagContainer& B);
	...
	static uint8 HasAllMatchingGameplayTags(TScriptInterface<class IGameplayTagAssetInterface> TagContainerInterface, const struct FGameplayTagContainer& OtherContainer);
	static uint8 HasAllTags(const struct FGameplayTagContainer& TagContainer, const struct FGameplayTagContainer& OtherContainer, uint8 bExactMatch);
	static uint8 HasAnyTags(const struct FGameplayTagContainer& TagContainer, const struct FGameplayTagContainer& OtherContainer, uint8 bExactMatch);
	static uint8 HasTag(const struct FGameplayTagContainer& TagContainer, const struct FGameplayTag& Tag, uint8 bExactMatch);
	static uint8 IsGameplayTagValid(const struct FGameplayTag& GameplayTag);
	...
	static uint8 MatchesAnyTags(const struct FGameplayTag& TagOne, const struct FGameplayTagContainer& OtherContainer, uint8 bExactMatch);
	static uint8 MatchesTag(const struct FGameplayTag& TagOne, const struct FGameplayTag& TagTwo, uint8 bExactMatch);
	static uint8 NotEqual_GameplayTag(const struct FGameplayTag& A, const struct FGameplayTag& B);
	static uint8 NotEqual_GameplayTagContainer(const struct FGameplayTagContainer& A, const struct FGameplayTagContainer& B);
	static uint8 NotEqual_TagContainerTagContainer(const struct FGameplayTagContainer& A, const class FString& B);
	static uint8 NotEqual_TagTag(const struct FGameplayTag& A, const class FString& B);
	static uint8 RemoveGameplayTag(struct FGameplayTagContainer& TagContainer, const struct FGameplayTag& Tag);
...
public:
	...
	uint8 HasAllMatchingGameplayTags(const struct FGameplayTagContainer& TagContainer) const;
	uint8 HasAnyMatchingGameplayTags(const struct FGameplayTagContainer& TagContainer) const;
	uint8 HasMatchingGameplayTag(const struct FGameplayTag& TagToCheck) const;
...
{
public:
	uint8                                         ImportTagsFromConfig : 1;                          // 0x0048(0x0001)(BitIndex: 0xFF, PropSize: 0x0001 (Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         WarnOnInvalidTags : 1;                             // 0x0049(0x0001)(BitIndex: 0xFF, PropSize: 0x0001 (Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	uint8                                         FastReplication : 1;                               // 0x0060(0x0001)(BitIndex: 0xFF, PropSize: 0x0001 (Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
