...
public:
	static class UGameplayTask_SpawnActor* SpawnActor(TScriptInterface<class IGameplayTaskOwnerInterface> TaskOwner, const struct FVector& SpawnLocation, const struct FRotator& SpawnRotation, TSubclassOf<class AActor> Class_0, uint8 bSpawnOnlyOnAuthority);

	uint8 BeginSpawningActor(class UObject* WorldContextObject, class AActor** SpawnedActor);
...
public:
	...
	uint8                                         bManuallySetID : 1;                                // 0x0030(0x0001)(BitIndex: 0xFF, PropSize: 0x0001 (Edit, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
public:
	...
	UMulticastDelegateProperty_                   OnClaimedResourcesChange;                          // 0x0168(0x0010)(BlueprintVisible, ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
