...
void UKismetProceduralMeshLibrary::CopyProceduralMeshFromStaticMeshComponent(class UStaticMeshComponent* StaticMeshComponent, int32 LODIndex, class UProceduralMeshComponent* ProcMeshComponent, uint8 bCreateCollision)
{
	static class UFunction* Func = nullptr;
...
void UKismetProceduralMeshLibrary::CreateGridMeshTriangles(int32 NumX, int32 NumY, uint8 bWinding, TArray<int32>* Triangles)
{
	static class UFunction* Func = nullptr;
...
// const struct FVector&                   PlanePosition                                          (Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const struct FVector&                   PlaneNormal                                            (Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// uint8                                   bCreateOtherHalf                                       (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UKismetProceduralMeshLibrary::SliceProceduralMesh(class UProceduralMeshComponent* InProcMesh, const struct FVector& PlanePosition, const struct FVector& PlaneNormal, uint8 bCreateOtherHalf, class UProceduralMeshComponent** OutOtherHalfProcMesh, EProcMeshSliceCapOption CapOption, class UMaterialInterface* CapMaterial)
{
	static class UFunction* Func = nullptr;
...
void UProceduralMeshComponent::AddCollisionConvexMesh(const TArray<struct FVector>& ConvexVerts)
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("ProceduralMeshComponent", "AddCollisionConvexMesh");
...
void UProceduralMeshComponent::ClearAllMeshSections()
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("ProceduralMeshComponent", "ClearAllMeshSections");
...
void UProceduralMeshComponent::ClearCollisionConvexMeshes()
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("ProceduralMeshComponent", "ClearCollisionConvexMeshes");
...
void UProceduralMeshComponent::ClearMeshSection(int32 SectionIndex)
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("ProceduralMeshComponent", "ClearMeshSection");
...
void UProceduralMeshComponent::CreateMeshSection(int32 SectionIndex, const TArray<struct FVector>& Vertices, const TArray<int32>& Triangles, const TArray<struct FVector>& Normals, const TArray<struct FVector2D>& UV0, const TArray<struct FColor>& VertexColors, const TArray<struct FProcMeshTangent>& Tangents, uint8 bCreateCollision)
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("ProceduralMeshComponent", "CreateMeshSection");
...
void UProceduralMeshComponent::CreateMeshSection_LinearColor(int32 SectionIndex, const TArray<struct FVector>& Vertices, const TArray<int32>& Triangles, const TArray<struct FVector>& Normals, const TArray<struct FVector2D>& UV0, const TArray<struct FLinearColor>& VertexColors, const TArray<struct FProcMeshTangent>& Tangents, uint8 bCreateCollision)
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("ProceduralMeshComponent", "CreateMeshSection_LinearColor");
...
void UProceduralMeshComponent::SetMeshSectionVisible(int32 SectionIndex, uint8 bNewVisibility)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = GetClass()->GetFunction("ProceduralMeshComponent", "SetMeshSectionVisible");
...
void UProceduralMeshComponent::UpdateMeshSection(int32 SectionIndex, const TArray<struct FVector>& Vertices, const TArray<struct FVector>& Normals, const TArray<struct FVector2D>& UV0, const TArray<struct FColor>& VertexColors, const TArray<struct FProcMeshTangent>& Tangents)
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("ProceduralMeshComponent", "UpdateMeshSection");
...
void UProceduralMeshComponent::UpdateMeshSection_LinearColor(int32 SectionIndex, const TArray<struct FVector>& Vertices, const TArray<struct FVector>& Normals, const TArray<struct FVector2D>& UV0, const TArray<struct FLinearColor>& VertexColors, const TArray<struct FProcMeshTangent>& Tangents)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = GetClass()->GetFunction("ProceduralMeshComponent", "UpdateMeshSection_LinearColor");
...
int32 UProceduralMeshComponent::GetNumSections() const
{
	...
	if (Func == nullptr)
		Func = GetClass()->GetFunction("ProceduralMeshComponent", "GetNumSections");
...
uint8 UProceduralMeshComponent::IsMeshSectionVisible(int32 SectionIndex) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = GetClass()->GetFunction("ProceduralMeshComponent", "IsMeshSectionVisible");
